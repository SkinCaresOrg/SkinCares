...
def handle_dupe(message: str, profile: Optional[Dict[str, Any]] = None) -> str:
    ...
    try:
        ...
        return f"I couldn't find dupes for that product. Please try browsing our products or asking for recommendations instead!"
...
def handle_info(message: str, profile: Optional[Dict[str, Any]] = None) -> str:
    ...
    ingredient = message.replace("what is", "").replace("tell me about", "").replace("info about", "").strip()
