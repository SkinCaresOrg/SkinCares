...
class TestContextualBandit:
    ...
    def test_select_product_exploit(self, bandit):
        ...
        # Force exploitation
        product_id, was_exploration = bandit.select_product(candidates, is_explore=False)
    ...
    def test_strategy_state(self, bandit):
        ...
        assert state["exploration_rate"] + state["exploitation_rate"] == pytest.approx(1.0)
...
class TestSwipeSession:
    ...
    def session(self):
        ...
        product_metadata = pd.DataFrame({
            ...
            "category": ["Moisturizer", "Cleanser", "Face Mask", "Treatment", "Eye Cream"]
            * (n_products // 5),
