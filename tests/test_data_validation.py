...
from skincarelib.ml_system.data_validation import DataValidationError, validate_artifact_inputs
...
def test_validate_artifact_inputs_success(tmp_path: Path):
    ...
    _write_csv(root / "skincarelib" / "datasets" / "datasets" / "products_clean.csv", products)
    _write_csv(root / "skincarelib" / "datasets" / "datasets" / "products_tokens.csv", tokens)
